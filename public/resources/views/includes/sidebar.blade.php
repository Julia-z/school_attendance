    ...
    <ul id="menu" class="bg-blue dker">
        ...
        Login Page
            ...
            Unlimited Level Menu
              ...
              <li class="">
                <a href="Measurement">
                  <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;Measurement</span>
                </a>
              </li>
              <li class="">
                <a href="MeasurementEmptying">
                  <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;Measurement Emptying</span>
                </a>
              </li>
              <li class="">
                <a href="Tanks">
                  <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;Tanks</span>
                </a>
              </li>
              <li class="">
                <a href="Buildings">
                  <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;Buildings</span>
                </a>
              </li>
              <li class="">
                <a href="Users">
                  <i class="fa fa-dashboard"></i><span class="link-title">&nbsp;Users</span>
                </a>
              </li>
              <br/>
              <br/>
