...
<!--  ?> -->
       ...
       <!-- sidebar content -->
                    <div id="sidebar" class="col-md-4" style="padding-top:30px;">
       ...
       <!-- main content -->
       <div id="content">
                    <div id="content" class="col-md-8" style="padding-top:30px;padding-left:50px;width:100%;height:100%">
                        <div class="outer">
                            <div class="inner bg-light lter" style="overflow: scroll;>
