...
<body>
	...
	<h1 align="center">Plant Inspection Point (PIP) API Documentation</h1>
	<br/>
	<br/>
	All Documents :
    <ul>
    ...
    <br/>
    <h4>
    	All requests should be made to: http://www.deerail.com/PIPApi
    </h4>
	<h4>
    ...
    <ul>
    	<li>Get Methods
        	<ul>
				...
				<li><a href="#get_inbound_trucks">Get Inbound Trucks</a></li>
	...
	<p>
        ...
        <code>http://deerail.com/PIPApi?type=Users&amp;username=xxx&amp;password=xxxxxxxxxxxxxxxxxxxxxx&amp;timestamp=2018-08-08 08:08:08</code>
        <br/>
        ...
        <ul>
            ...
            <li>pip_app (Boolean, if 1 user can log into the app)</li>
         </ul>
     </p>
     
    <h4 id="get_inbound_trucks">Get Inbound Trucks</h4>
    <p>
    	The call should look like this<br/>
        <code>http://deerail.com/PIPApi?type=GetRemainingTrucks&amp;username=xxx&amp;password=xxxxxxxxxxxxxxxxxxxxxx&amp;timestamp=2018-08-08 08:08:08</code>
        <br/>
    	<span>This call return a list of all Trucks that went into the plant</span>
        <br/>
	...
	<p>
    	The call should look like this<br/>
        <code>http://deerail.com/PIPApi?type=Destinations&amp;username=xxx&amp;password=xxxxxxxxxxxxxxxxxxxxxx&amp;timestamp=2018-08-08 08:08:08</code>
        <br/>
	...
	<p>
    	The call should look like this<br/>
        <code>http://deerail.com/PIPApi?type=Trucks&amp;username=xxx&amp;password=xxxxxxxxxxxxxxxxxxxxxx&amp;timestamp=2018-08-08 08:08:08</code>
        <br/>
	...
	<p>
    	The call should look like this<br/>
        <code>http://deerail.com/PIPApi?type=Comment&amp;username=xxx&amp;password=xxxxxxxxxxxxxxxxxxxxxx&amp;Comment=[xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx]</code>
        <br/>
	...
	<p>
        ...
        <ul>
            ...
            <li>Driver_Id (GUID)</li>
            <li>Controller_Id (GUID)</li>
            <li>Destination_Id (GUID)</li>
            <li>Truck_Id (GUID)</li>            
            <li>Truck_volume</li>
