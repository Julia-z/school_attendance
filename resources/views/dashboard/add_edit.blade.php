...
<button class="btn btn-success" onclick="location.href='/register?page_selected_table={{ $page_selected_table }}'" style="float: left; width: 40%; margin-left: 30%; margin-right: 30%;">+ New Entry</button>
@else
