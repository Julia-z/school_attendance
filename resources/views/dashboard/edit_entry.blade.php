...
<button class="btn btn-success" onclick="location.href='/tables?table_name={{$page_selected_table}}'" style="float: left; width: 40%; margin-left: 30%; margin-right: 30%;">Go back to table view</button>
@endif
